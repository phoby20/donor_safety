function FullTextSearch()
{
    ...
    this.param_name4 = 'collect_place'; //collect_place 検索
...
FullTextSearch.prototype = {
    init : function (fullTextData, keyword)
    {
        ...
        this.collect_place   = keyword;  //pbsch 検索
        ...
        this.collect_place = this.getParam4(this.collect_place);  //collect_place 検索
    ...
    // 一般キーワードが入る
    do_find : function (keyword,alert_type,section_state,collect_place,refine1,refine2,yearfrom,yearto,hasimage,class1,class2,class3)
    {
        // console.log(keyword);
        ...
        if (this.lastquery == collect_place) return; //collect_place 検索時

        this.lastquery = keyword;
        this.lastquery = alert_type; //alert_type 検索時
        this.lastquery = section_state; //section_state 検索時
        this.lastquery = collect_place; //collect_place 検索時

        var re = this.find(keyword,alert_type,section_state,collect_place,refine1,refine2,yearfrom,yearto,hasimage,class1,class2,class3);
    ...
    ,
    find : function (keyword,alert_type,section_state,collect_place,refine1,refine2,yearfrom,yearto,hasimage,class1,class2,class3)
    {
        ...
        var query4 = null; //collect_place 検索時
        ...
        //collect_place入力ありの場合
        if (collect_place != ""){
            query4= this.splitKeyword(collect_place);
        }
        ...
        var d_key4 = ['place']; //collect_place　検索時！
        ...
        for (var i = 0, d_len = this.dataset.length; i < d_len; i++) {
            ...
            var r4, rg4; //collect_place 検索時

            var d_length = 0;
            var d_length2 = 0;//BMH 検索時
            var d_length3 = 0;//PBSCH 検索時
            var d_length4 = 0;//collect_place 検索時
